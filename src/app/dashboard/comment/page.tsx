...
export default function CommentEdit() {
    ...
    useEffect(() => {
        ...
        setUserName(name || "");
        console.log("000000000000000000", name)
            ...
            <div className="flex flex-1 pt-15 overflow-hidden">
                ...
                <div className={`flex-1 flex flex-col transition-all duration-300 bg-gray-200`}>
                    ...
                    <div className="flex-1 overflow-auto py-6 px-2 mb-12">
                        ...
                        {/* Back Button */}
                        <button onClick={() => router.push('/dashboard')} className="flex font-bold text-white items-center justify-end gap-2 rounded-md mb-5 mx-4 px-4 py-2 hover:bg-black hover:text-white pl-auto bg-black"><ArrowLeft size={30} /> <span>Back to Blog</span></button>


                        <div className="flex flex-col bg-white shadow-lg rounded-2xl mx-auto">

                            <h1 className="flex text-2xl border rounded-t-2xl font-bold bg-black text-white mb-6 border-b-2 p-6">Blog Add Form</h1>
                            ...
                            <form onSubmit={handleSubmit} className="w-full space-y-4 px-6 pb-6 text-black">
                                ...
                                <div>
                                    ...
                                    <div>
                                        {userName &&
                                            <h1 className="bg-white overflow-auto w-auto text-black-600">{userName.toUpperCase()}</h1>
                                        }
                                    </div>
                                    {/* <select
                                        id="userId"
